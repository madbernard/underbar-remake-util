(function() {
  ...
  _.last = function(array, n) {
    ...
    else return n === undefined ? array[array.length - 1] : array.slice(array.length - n);
  };
  ...
  _.uniq = function(array) {
    var uniqArray = _.filter(array, function(eachItem){
      return _.indexOf(uniqArray, eachItem) === -1;
    });
    return uniqArray;
  };
